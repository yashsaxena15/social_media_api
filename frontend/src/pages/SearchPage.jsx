    ...
    <div>
      ...
      {!loading && searched && (
        <>
                ...
                {hasMoreUsers && (
                  <div className="p-3 bg-gray-50 border-t border-gray-100">
                    <button
                      ...
                      className="w-full py-2 bg-white border border-gray-200 hover:bg-gray-100 text-gray-700 rounded-lg text-sm font-medium transition-colors disabled:opacity-50"
                    >
          ...
          {posts.length > 0 && (
            <div>
              <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Posts</h3>
              {posts.map((post, idx) => (
              ...
              {hasMorePosts && (
                <div className="mb-6">
                  <button
                    ...
                    className="w-full py-3 bg-white border border-gray-200 shadow-sm hover:bg-gray-50 text-gray-700 rounded-lg text-sm font-medium transition-colors disabled:opacity-50"
                  >
